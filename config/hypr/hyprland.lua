...
local terminal    = "foot"
local fileManager = "foot -e ranger"
local menu        = "fuzzel"
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(255, 255, 255, 0.12)"}},
            inactive_border = "rgba(17, 17, 17, 0)",
        },
...
hl.bind(mainMod .. " + V", hl.dsp.exec_cmd([[cliphist list | fuzzel --dmenu --width=45 --with-nth 2 | cliphist decode | wl-copy]]))
